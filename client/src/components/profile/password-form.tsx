  ...
  return (
    <div className="bg-white rounded-lg border border-[#C9CFD2] p-6 mb-6 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {passwordFields.map((field) => (
          <div key={field.name}>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                onClick={() => toggleVisibility(field.name as keyof typeof visibility)}
        ...
        <button
          type="submit"
          className="w-full px-6 py-2 bg-[#1E40AF] text-white rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-sm"
        >
          Đổi mật khẩu
        </button>
      </form>
