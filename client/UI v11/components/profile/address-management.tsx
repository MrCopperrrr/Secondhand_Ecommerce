...
export function AddressManagement() {
  ...
  return (
    <section className="bg-white rounded-lg border border-[#C9CFD2] p-8 mb-6">
      {/* Section Heading */}
      ...
      {/* Add Address Button */}
      <button className="w-full py-3 border-2 border-[#1E40AF] rounded-lg text-[#1E40AF] font-bold uppercase tracking-wide hover:bg-[#F0F4FF] transition-colors">
